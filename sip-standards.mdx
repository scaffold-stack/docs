...
keywords: ["SIP-010", "SIP-009", "Stacks token", "Stacks NFT", "Clarity token", "Scaffold Stacks", "stacksdapp add", "SIP-010 tutorial"]
---
...
Watch how to add SIP-010 and SIP-009 contracts with Scaffold Stacks templates (`stacksdapp add --template sip010` / `sip009`), then generate hooks, test, and deploy to testnet.

Continues from the [donation jar tutorial](/video-tutorial) (Part 1).
...
Open on [YouTube](https://www.youtube.com/watch?v=5txLPdw_fa0). Follow along in the [donation-jar-tutorial](https://github.com/scaffold-stack/donation-jar-tutorial) repo.
...
For a complete SIP-010 app with custom UI (claim, mint, transfer), see **DropClaim** in [Example dApps](/examples).
